...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2()
    {
        ...
        c2.setFont(new Font("Raleway",Font.BOLD,14));
         ...
         String income[] = {"Null","<1,50,000","<2,50,000","<5,00,000","<7,50,000","upto 10,00,000","Above 10,00,000"};
        c3 = new JComboBox(income);
        c3.setBackground(Color.WHITE);
        c3.setFont(new Font("Raleway",Font.BOLD,14));
        
         String education[] = {"Doctorate","Post Graduate","Under Graduate","12th/Diploma","10th","Other"};
        c4 = new JComboBox(education);
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Raleway",Font.BOLD,14));
        
        String occupation[] = {"Salaried","Self-Employed","Buisness","Student","Retired","Others"};
